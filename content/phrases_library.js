// stemOS Professional & Native Technical Phrases Library
...
var STEMOS_PHRASES = [
  ...
  {
    "id": "phr-boil-the-ocean",
    "phrase": "Let us focus on fixing the soldering defects first instead of trying to boil the ocean",
    "schoolVsNative": {
      "school": "Do not try to solve all problems at once.",
      "native": "Let us fix the soldering first instead of trying to boil the ocean."
    },
    "meaningES": "Concentrémonos en resolver los defectos de soldadura primero en vez de intentar abarcarlo todo de golpe (boil the ocean)",
    "explanation": "Advertencia pragmática contra intentar abordar un alcance imposiblemente ambicioso que diluye los recursos del equipo.",
    "category": "problem_solving",
    "exampleEN": "Rather than redesigning the entire ERP system, let us not boil the ocean; let us automate the purchase order workflow first.",
    "exampleES": "En vez de rediseñar todo el sistema ERP, no pretendamos abarcarlo todo; automaticemos primero el flujo de órdenes de compra.",
    "pronunciationHint": "Metáfora: /bɔɪl ðə ˈoʊʃən/."
  },
  {
    "id": "phr-apples-to-oranges-audit",
    "phrase": "Comparing hydraulic press throughput with electric servo press cycle time is comparing apples to oranges",
    "schoolVsNative": {
      "school": "These two machines are completely different.",
      "native": "Comparing hydraulic throughput with servo press cycle time is apples to oranges."
    },
    "meaningES": "Comparar el rendimiento de una prensa hidráulica con el de una servoprensa eléctrica es comparar peras con manzanas",
    "explanation": "Objeción técnica contundente cuando se contrastan dos tecnologías con principios de operación y perfiles de costo dispares.",
    "category": "technical_debate",
    "exampleEN": "Benchmarking standard lead-acid battery life against solid-state lithium cells is comparing apples to oranges.",
    "exampleES": "Comparar la vida útil de baterías de plomo-ácido con celdas de litio de estado sólido es comparar peras con manzanas.",
    "pronunciationHint": "Expresivo: /ˈæpəlz tə ˈɔːrɪndʒɪz/."
  },
  {
    "id": "phr-hit-the-nail-on-the-head",
    "phrase": "Maria hit the nail on the head: the primary bottleneck is cleanroom air turnover",
    "schoolVsNative": {
      "school": "Maria said the exact correct thing.",
      "native": "Maria hit the nail on the head regarding the cleanroom bottleneck."
    },
    "meaningES": "María dio en el clavo con total exactitud: el cuello de botella principal es la tasa de renovación de aire en el cuarto limpio",
    "explanation": "Reconocimiento y validación pública en una reunión técnica de una conclusión exacta y certera.",
    "category": "meetings",
    "exampleEN": "Our reliability engineer hit the nail on the head when he pointed out thermal fatigue on the solder joints.",
    "exampleES": "Nuestro ingeniero de confiabilidad dio en el clavo cuando señaló la fatiga térmica en las uniones de soldadura.",
    "pronunciationHint": "Ligado: /hɪt ðə neɪl ɑːn ðə hɛd/."
  },
  {
    "id": "phr-bite-the-bullet",
    "phrase": "We need to bite the bullet and replace the legacy PLC controller before it fails completely",
    "schoolVsNative": {
      "school": "We must do the difficult expensive thing now.",
      "native": "We need to bite the bullet and replace the legacy PLC controller."
    },
    "meaningES": "Debemos apretarnos el cinturón / dar el paso difícil (bite the bullet) y reemplazar el controlador PLC obsoleto antes de que falle del todo",
    "explanation": "Decisión directiva de afrontar un gasto o cambio doloroso e inevitable de inmediato para evitar una catástrofe mayor después.",
    "category": "conflict_resolution",
    "exampleEN": "Upgrading to a 5-axis CNC mill is expensive, but management bit the bullet to keep the aerospace turbine contract.",
    "exampleES": "Actualizar a un centro de maquinado de 5 ejes es costoso, pero la dirección dio el paso difícil para conservar el contrato de turbinas aeroespaciales.",
    "pronunciationHint": "Firme: /baɪt ðə ˈbʊlɪt/."
  },
  {
    "id": "phr-run-the-numbers",
    "phrase": "Let us run the numbers on the tooling amortization before we submit the bid",
    "schoolVsNative": {
      "school": "Let us calculate the financial math before bidding.",
      "native": "Let us run the numbers on tooling amortization before submitting the bid."
    },
    "meaningES": "Hagamos los cálculos numéricos y proyecciones (run the numbers) sobre la amortización de herramentales antes de enviar la cotización",
    "explanation": "Analizar detenidamente los modelos financieros, costos unitarios y retornos de inversión antes de tomar una decisión comercial.",
    "category": "metrics",
    "exampleEN": "Before finalizing the contract for the high-pressure die casting cell, let us run the numbers on electricity consumption tariffs.",
    "exampleES": "Antes de finalizar el contrato de la celda de fundición a alta presión, hagamos los números sobre las tarifas de consumo eléctrico.",
    "pronunciationHint": "Coloquial profesional: /rʌn ðə ˈnʌmbərz/."
  }
];
