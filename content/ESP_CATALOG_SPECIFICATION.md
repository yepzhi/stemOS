...
```mermaid
graph TD
    A[stemOS ESP Master Catalog] --> B[🔵 TECHNOLOGY<br>6 Tracks]
    A --> C[🟢 ENGINEERING & INDUSTRY<br>8 Tracks]
    A --> D[🟣 SCIENCE & FUTURE TECH<br>6 Tracks]
    A --> E[🟠 AVIATION, CAREER & PRO<br>6 Tracks]

    B --> B1[Smart Networks & Cybersecurity]
    B --> B2[Information Technology & Digital Innovation]
    B --> B3[AI & Machine Learning ⭐]
    B --> B4[Telecommunications & IoT]
    B --> B5[Software Development & Programming]
    B --> B6[Data Science & Analytics ⭐]

    C --> C1[Semiconductor Manufacturing]
    C --> C2[Electromobility & EV Engineering]
    C --> C3[Aerospace Manufacturing]
    C --> C4[Robotics & Automation ⭐]
    C --> C5[Energy & Renewable Technologies ⭐]
    C --> C6[Engineering & Advanced Manufacturing]
    C --> C7[Industrial Engineering & Operations]
    C --> C8[Mechanical Engineering & Mechatronics]

    D --> D1[Biotechnology & Life Sciences]
    D --> D2[Space & Satellite Technology]
    D --> D3[Environmental & Sustainability]
    D --> D4[Healthcare Technology]
    D --> D5[Materials Science & Nanotechnology]
    D --> D6[Food Science & Technology]

    E --> E1[Aviation English ⭐]
    E --> E2[Air Force Aerospace English ⭐]
    E --> E3[Hospitality & Food Service English]
    E --> E4[Business, Leadership & Management English]
    E --> E5[Project Management & Professional Communication]
    E --> E6[Entrepreneurship & Innovation English]
```
