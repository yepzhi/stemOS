/**
 * stemOS Dev Content Studio — PWA Service Worker (v1.2.0 Centered Modal & Level Switcher)
 * Enables 100% complete offline caching for 50 modules, readings, native phrases, and assets.
 */

const CACHE_NAME = 'stemos-dev-v1.2.0';
...
const ASSETS_TO_CACHE = [
  ...
  '/dev.css?v=1.2.0',
  '/dev.js?v=1.2.0',
  '/content/courses.js?v=1.2.0',
  '/content/phrases_library.js?v=1.2.0',
