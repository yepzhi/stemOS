...
const existingCode = fs.readFileSync(path.join(__dirname, '..', 'content/phrases_library.js'), 'utf8');
const ctx = { window: {}, module: { exports: {} } };
vm.runInNewContext(existingCode, ctx);
const existingPhrases = ctx.STEMOS_PHRASES || ctx.module.exports;

// Fix existing duplicate IDs
existingPhrases[40].id = "phr-ducks-in-row-audit";
existingPhrases[44].id = "phr-touch-base-manager";

// New high-caliber engineering, research, and executive phrases
const newPhrases = [
  // =========================================================================
  // CATEGORÍA: MEETINGS & STRATEGY (16 Frases)
  // =========================================================================
  {
  ...
  // =========================================================================
  // CATEGORÍA: PROBLEM SOLVING & ROOT CAUSE (16 Frases)
  // =========================================================================
  {
    id: "phr-pinch-point",
  ...
  // =========================================================================
  // CATEGORÍA: SOFT SKILLS & LEADERSHIP (14 Frases)
  // =========================================================================
  {
  ...
  // =========================================================================
  // CATEGORÍA: METRICS & REPORTING (8 Frases Nuevas)
  // =========================================================================
  {
  ...
  // =========================================================================
  // CATEGORÍA: SMALL TALK & NETWORKING (7 Frases Nuevas)
  // =========================================================================
  {
  ...
  // =========================================================================
  // CATEGORÍA: TECHNICAL DEBATE & ARCHITECTURE (4 Frases Nuevas)
  // =========================================================================
  {
  ...
  // =========================================================================
  // CATEGORÍA: CONFLICT RESOLUTION & DIPLOMACY (4 Frases Nuevas)
  // =========================================================================
  {
    id: "phr-meet-halfway",
  ...
  // =========================================================================
  // CATEGORÍA: WORKPLACE OPERATIONS (1 Frase Nueva)
  // =========================================================================
  {
...
// Combine existing phrases with new phrases
const allPhrases = [...existingPhrases, ...newPhrases];
...
console.log(`Successfully compiled ${allPhrases.length} total phrases across all 8 dimensions!`);
...
var STEMOS_PHRASES = ${JSON.stringify(allPhrases, null, 2)};
...
fs.writeFileSync(path.join(__dirname, '..', 'content/phrases_library.js'), outputHeader, 'utf8');
console.log('[SUCCESS] content/phrases_library.js updated successfully!');
